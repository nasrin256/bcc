...
static const struct argp_option opts[] = {
	{ "threads", 't', "MAX-THREADS", 0,
	  "the number of threads to trace (default 65536, 40 bytes per thread)", 0 },
	{ "edges", 'e', "MAX-EDGES", 0, "the number of edge cases that can be recorded "
	  "(default 65536, 88 bytes per edge case)", 0 },
	...
	{ "unlock-symbols", OPT_UNLOCK_SYMBOLS, "UNLOCK_SYMBOLS", 0,
	  ...
	  "These symbols cannot be inlined in the binary.", 0 },
	{ "interval", 'i', "INTERVAL", 0, "interval in seconds to detect potential deadlocks", 0 },
